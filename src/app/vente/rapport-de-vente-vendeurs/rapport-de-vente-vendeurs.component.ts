...
@Component({
  selector: 'app-rapport-de-vente-vendeurs',
  templateUrl: './rapport-de-vente-vendeurs.component.html',
  styleUrls: ['./rapport-de-vente-vendeurs.component.scss'],
})
export class RapportDeVenteVendeursComponent {
  dataSource!: any;
  displayedColumns = [
    'date_vente',
    'montant_total',
  ...
  getListVente() {
    ...
    this.venteService
      .getVenteByPointDeVente(this.user.point_de_vente_id)
      .subscribe((data) => {
        console.log(data.message);
