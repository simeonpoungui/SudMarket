...
@Component({
  selector: 'app-stock-produits-variables-entrepots',
  templateUrl: './stock-produits-variables-entrepots.component.html',
  styleUrls: ['./stock-produits-variables-entrepots.component.scss']
})
export class StockProduitsVariablesEntrepotsComponent {
