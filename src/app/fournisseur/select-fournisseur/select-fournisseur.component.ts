...
@Component({
  selector: 'app-select-fournisseur',
  templateUrl: './select-fournisseur.component.html',
  styleUrls: ['./select-fournisseur.component.scss']
})
export class SelectFournisseurComponent {
  dataSource!: any;
  displayedColumns = [
    'nom',
    'prenom',
  ...
  onClickLine(fournisseur: Fournisseur){
    console.log(fournisseur.fournisseur_id);
